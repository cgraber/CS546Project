 ...
 */
public class CoarseExtentNERAnnotator extends NERAnnotator {
    public CoarseExtentNERAnnotator() {
        super(true, ViewNames.NER_ACE_COARSE_EXTENT);
    }

    public static void main(String[] argv) throws IOException {
        Annotator annotator = new CoarseExtentNERAnnotator();
        ...
        Server server = new Server(5757, new ServerPreferences(10000, 1), annotator);
